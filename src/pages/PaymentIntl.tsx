...
export default function PaymentIntl() {
  ...
  useEffect(() => {
    if (countdown > 0) {
      ...
      setRedirecting(true);
              // Redirection automatique vers Konnect International
        const konnectUrl = "https://knct.me/VnXSe9LmA";
        ...
        <div className="bg-white p-8 rounded-xl border border-gray-100 shadow-lg">
          ...
          <div className="bg-gray-50 p-4 rounded-lg mb-6 text-left">
            ...
            <div className="grid grid-cols-2 gap-2 text-sm text-gray-700">
              ...
              <div><span className="font-medium">Pays :</span> {country}</div>
            ...
            <div className="mt-3">
              ...
              <div className="font-medium text-primary">Prix : 300 USD</div>
            </div>
          </div>
