                  ...
                  <div className="space-y-6">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">contact@ktconsulting.info</p>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">+216 55 053 505</p>
                        <p className="text-sm text-gray-500">WhatsApp : +216 98 704 385</p>
